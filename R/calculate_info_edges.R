...
#'
#' @details The information contribution of an edge \eqn{e} to a graph \eqn{G} is given by \eqn{I(G,e)=C(G)-C(G-e)}, where \eqn{C(G)} denotes the information content of \eqn{G} and \eqn{C(G-e)} the information content of \eqn{G} after removing \eqn{e} from \eqn{G}.
